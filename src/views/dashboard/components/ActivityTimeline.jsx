      ...
      <DrogaCard {...other} sx={{ p: 0 }}>
        ...
        >
          {loading ? (
            ...
            <ErrorPrompt
              title="Server Error"
              message={`There is an issue getting the fiscal year timelines`}
              size={100}
            />
          ) : data.length === 0 ? (
            <Fallbacks
      ...
      <TimelineSeparator>
        {item.timeline_status ? (
          <IconCircleCheckFilled
            size="1.4rem"
            stroke={1.8}
            style={{ color: '#009e48', marginTop: 10 }}
          />
        ) : (
        ...
        {lastItem ? null : (
          <TimelineConnector
            sx={{
              backgroundColor: item.timeline_status ? '#009e48' : '#e0e0e0',
              my: 0.4,
            }}
          />
        )}
