...
import UnitPerKPIPerformance from './UnitPerKPIPerformance';

const UnitPerformanceReport = ({ id }) => {
...
UnitPerformanceReport.propTypes = {
  id: PropTypes.string,
};

export default UnitPerformanceReport;
