        ...
        <form noValidate onSubmit={formik.handleSubmit}>
          <DialogContent>
            ...
            <FormControl
              fullWidth
              error={
                formik.touched.parent_unit_type &&
                Boolean(formik.errors.parent_unit_type)
              }
              sx={{ marginTop: 3 }}
            >
              <InputLabel htmlfor="parent_unit_type">
                Parent Unit type
              </InputLabel>
            ...
            >
              ...
              {formik.touched.parent_id && formik.errors.parent_id && (
                <FormHelperText
                  error
                  id="standard-weight-helper-text-parent_id"
                >
            ...
            <FormControl
              ...
              sx={{ marginTop: 3 }}
            >
              <InputLabel htmlfor="head">Head Unit</InputLabel>
