  ...
  return (
    <DrogaCard sx={{ padding: 3 }}>
      ...
      {userInfo?.user?.username && (
        <InfoList label={'Employee ID'} info={userInfo?.user?.username} />
      )}
      {userInfo?.user?.name && (
        <InfoList label={'Full name'} info={userInfo?.user?.name} />
      )}
      {userInfo?.user?.email && (
        <InfoList label={'Email'} info={userInfo?.user?.email} />
      )}
      {userInfo?.user?.phone && (
        <InfoList label={'Phone'} info={userInfo?.user?.phone} />
      )}
      ...
      <InfoList
        label={'Start date'}
        info={formattedDate(userInfo?.unit?.started_date)}
      />
    </DrogaCard>
  );
};
